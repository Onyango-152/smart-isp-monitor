...
class DummyData {
  ...
  static final List<TaskModel> tasks = [
    TaskModel(
      id: 1, name: 'Core Router SNMP Poll',
      description: 'Polls CPU, memory, bandwidth, and interface counters from the core router via SNMP v2c.',
      deviceId: 1, deviceName: 'Core Router',
      taskType: 'snmp', intervalSecs: 300, timeoutSecs: 5,
      enabled: true,
      lastRun: _ago(minutes: 5), lastStatus: 'success',
      createdAt: _ago(days: 365),
    ),
    TaskModel(
      id: 2, name: 'OLT-01 SNMP Poll',
      description: 'Polls OLT-01 for optical signal levels, bandwidth, and error counters.',
      deviceId: 3, deviceName: 'OLT-01',
      taskType: 'snmp', intervalSecs: 300, timeoutSecs: 5,
      enabled: true,
      lastRun: _ago(minutes: 10), lastStatus: 'success',
      createdAt: _ago(days: 300),
    ),
    TaskModel(
      id: 3, name: 'AP Rooftop Ping',
      description: 'ICMP ping check for AP — Rooftop reachability and latency.',
      deviceId: 4, deviceName: 'AP — Rooftop',
      taskType: 'ping', intervalSecs: 60, timeoutSecs: 3,
      enabled: true,
      lastRun: _ago(minutes: 1), lastStatus: 'failed',
      createdAt: _ago(days: 270),
    ),
    TaskModel(
      id: 4, name: 'All Devices Ping Sweep',
      description: 'Quick ICMP ping to every active device — checks basic reachability.',
      deviceId: null, deviceName: null,
      taskType: 'ping', intervalSecs: 120, timeoutSecs: 3,
      enabled: true,
      lastRun: _ago(minutes: 2), lastStatus: 'success',
      createdAt: _ago(days: 200),
    ),
    TaskModel(
      id: 5, name: 'Gateway HTTP Health',
      description: 'Checks the upstream ISP gateway web portal returns HTTP 200.',
      deviceId: 1, deviceName: 'Core Router',
      taskType: 'http', intervalSecs: 600, timeoutSecs: 10,
      enabled: true,
      lastRun: _ago(minutes: 10), lastStatus: 'success',
      createdAt: _ago(days: 180),
    ),
    TaskModel(
      id: 6, name: 'DNS Resolution Check',
      description: 'Verifies local DNS resolver can resolve external domains within threshold.',
      deviceId: null, deviceName: null,
      taskType: 'dns', intervalSecs: 300, timeoutSecs: 5,
      enabled: true,
      lastRun: _ago(minutes: 5), lastStatus: 'success',
      createdAt: _ago(days: 150),
    ),
    TaskModel(
      id: 7, name: 'Switch A TCP Port Check',
      description: 'TCP connect to management port 22 (SSH) on Access Switch A.',
      deviceId: 2, deviceName: 'Access Switch A',
      taskType: 'tcp', intervalSecs: 300, timeoutSecs: 5,
      enabled: true,
      lastRun: _ago(minutes: 5), lastStatus: 'success',
      createdAt: _ago(days: 120),
    ),
    TaskModel(
      id: 8, name: 'OLT-02 SNMP Poll',
      description: 'Polls OLT-02 for optical signal levels, bandwidth, and error counters.',
      deviceId: 7, deviceName: 'OLT-02',
      taskType: 'snmp', intervalSecs: 300, timeoutSecs: 5,
      enabled: true,
      lastRun: _ago(minutes: 5), lastStatus: 'success',
      createdAt: _ago(days: 180),
    ...
    TaskModel(
      id: 9, name: 'Block C AP Ping',
      description: 'ICMP ping for AP — Block C with elevated error threshold monitoring.',
      deviceId: 8, deviceName: 'AP — Block C',
      taskType: 'ping', intervalSecs: 60, timeoutSecs: 3,
      enabled: true,
      lastRun: _ago(minutes: 1), lastStatus: 'success',
      createdAt: _ago(days: 90),
    ),
    TaskModel(
      id: 10, name: 'Backup Router SNMP Poll',
      description: 'Polls failover router for standby readiness metrics.',
      deviceId: 5, deviceName: 'Backup Router',
      taskType: 'snmp', intervalSecs: 600, timeoutSecs: 5,
      enabled: false,
      lastRun: _ago(days: 7), lastStatus: 'success',
      createdAt: _ago(days: 250),
    ),
    TaskModel(
      id: 11, name: 'Switch B HTTP Portal',
      description: 'Checks the web management portal on Access Switch B returns HTTP 200.',
      deviceId: 6, deviceName: 'Access Switch B',
      taskType: 'http', intervalSecs: 600, timeoutSecs: 10,
      enabled: false,
      lastRun: _ago(days: 3), lastStatus: 'failed',
      createdAt: _ago(days: 100),
    ),
  ];
